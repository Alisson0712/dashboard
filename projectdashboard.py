...
# Choropleth map function for the top 10 countries
def choropleth_map(df):
    ...
    # Clean the 'country' column to remove any leading/trailing spaces and NaN values
    ...
    # Debugging: Display the top 10 countries to verify the data
    st.write("Top 10 Countries with Most Titles:", country_count)

    # Create the choropleth map for the top 10 countries
    try:
        # Plotly Choropleth Map
        fig = px.choropleth(country_count,
                            locations="country",
                            locationmode='country names',  # Make sure locationmode is set to 'country names'
                            color="count",
                            color_continuous_scale="Viridis",
                            labels={'count': 'Number of Titles'},
                            title="Top 10 Netflix Titles by Country")

        # Display the map
        st.plotly_chart(fig)
    except Exception as e:
        st.error(f"An error occurred while rendering the choropleth map: {e}")
...
if df_cleaned is not None:
    ...
    elif selected_graph == "Choropleth Map: Titles in the 10 top Countries":
...
if df_cleaned is None or df_cleaned.empty:
    ...
    col1, col2, col3 = st.columns([3, 3, 3], gap ='medium') # Three equal columns
