...
def choropleth_map(df):
    ...
    st.write("Top 5 Countries with the Most Titles:", top_countries)

    # Get the top 5 countries with the most titles
    country_count = df['country'].value_counts().head(5).reset_index()
    country_count.columns = ['country', 'count']

    # Debugging: Display the country names before rendering the map
    st.write("Country data after cleaning:", country_count)
...
if df_cleaned is None or df_cleaned.empty:
    ...
    col1, col2, col3 = st.columns([2, 1, 2])  # First and third columns take more space than the second one
