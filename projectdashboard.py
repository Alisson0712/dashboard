...
if df_cleaned is None or df_cleaned.empty:
    ...
    # Create 2 columns layout in Streamlit (side-by-side layout)
    col1, col2 = st.columns([1, 3])  # Adjust the column size as needed

    # In the first column, we can place other content if needed (currently empty)
    with col1:
        st.empty()
    ...
    # Now, move the third column content below the graphs
