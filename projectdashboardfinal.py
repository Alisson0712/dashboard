...
with st.sidebar:
    ...
    graph_options = [
        ...
        "Choropleth Map: Titles for the top 5 countries",
...
def choropleth_map(df):
    ...
    # Debugging: Display the top 5 countries to verify the data
    country_count = df['country'].value_counts().head(5).reset_index()
    country_count.columns = ['country', 'count']

    # Debug: Display the top 5 countries and ensure no issues
    st.write("Top 5 Countries with Most Titles:", country_count)
...
if df_cleaned is None or df_cleaned.empty:
    ...
    col1, col2, col3 = st.columns([1.5, 3, 2], gap ='medium') # Three equal columns
